...
namespace detail
{
  ...
  inline bool shallExecuteScopeGuard( OnFailTag    ) { return  std::uncaught_exceptions(); }
  inline bool shallExecuteScopeGuard( OnSuccessTag ) { return !std::uncaught_exceptions(); }
